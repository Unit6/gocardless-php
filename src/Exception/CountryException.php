...
/**
 * Exceptions pertaining to an invalid country
 *
 * @author Unit6 <team@unit6websites.com>
 */
class CountryException extends GoCardless\Exception
{
    /**
     ...
     */
    public function __construct($message = 'Country error', $code = 0)
    {
